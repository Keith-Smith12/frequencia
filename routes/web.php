...
Route::prefix('projectoUsuario')->group(function () {
    ...
    Route::get('tarefaUsuario/', [TarefaUsuarioController::class, 'index'])->name('tarefaUsuario.index');
    Route::get('atraso/', [AtrasoController::class, 'index'])->name('atraso.index');
    Route::get('projecto/', [ProjectoController::class, 'index'])->name('projecto.index');
